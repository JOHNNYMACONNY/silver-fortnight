import { verifyIndexes, parseIndexDefinitions, compareIndexes, IndexDefinition, DeployedIndex } from '../verify-indexes';
...
const mockFirestoreAdmin = admin.firestore() as any;

...
import { MessageSquare, User, Calendar, CheckCircle2, AlertCircle, Edit } from 'lucide-react';
      ...
      <div className="card card-form">
        <div className="p-6">
          ...
          <div className="flex gap-4">
            ...
            {user && (user.uid === trade.creatorId || (isAdmin && adminModeEnabled)) && (
              <button
                type="button"
                onClick={() => {
                  console.log('Trade Details: Edit button clicked');
              ...
              {trade.status === 'open' && (
                <>
                  <button
                    ...
                    disabled={updatingStatus}
                    className="w-full flex items-center justify-center gap-2 px-4 py-2 rounded bg-white hover:bg-gray-50 text-gray-900 border border-accent-clay transition-colors"
                  >

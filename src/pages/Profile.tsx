...
export function Profile() {
  ...
  const canManageProfile = (isAdmin && adminModeEnabled) || user?.uid === profile.id;
            ...
            <div>
              ...
              <div className="flex gap-2">
                {isEditing ? (
                  ...
                  // Show edit button only if user owns the profile or is an admin with admin mode enabled
                  (user?.uid === profile.id || (isAdmin && adminModeEnabled)) && (
                    <button
          ...
          <div className="mb-8">
            <h2 className="text-lg font-display font-semibold text-gray-900 mb-3">
              ...
              {isAdmin && !isEditing && (
                <button
                  onClick={() => setIsEditing(true)}
                  className="ml-2 p-1 text-sm text-neon-blue hover:text-neon-purple transition-colors"
                  title="Edit skills as admin"
                >

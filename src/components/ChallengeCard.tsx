...
import { Trophy, Clock, Users, CheckCircle, Star, ArrowRight, RefreshCw } from 'lucide-react';
import { useAuth } from '../contexts/AuthContext';
import { useAdmin } from '../contexts/AdminContext';
import { Challenge } from '../types';
import { joinChallenge, claimChallengeRewards, regenerateChallenge } from '../lib/challenges';
  ...
  return (
    <div className="card group">
      <div className="p-6">
        ...
        {/* Actions */}
        <div className="relative mt-6 pt-4 border-t border-earth-700">
            ...
            <div className="absolute top-4 right-0 flex items-center gap-2">
              <ManagementActions
                ...
                onRegenerate={async () => {
                  ...
                  try {
                    await regenerateChallenge(challenge.id);
                  } catch (err) {
                    console.error('Failed to regenerate challenge:', err);
                  } finally {

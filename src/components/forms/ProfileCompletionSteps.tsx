...
const TRADING_INTERESTS: DropdownOption[] = [
  ...
  },
  {
    ...
    description: "Equipment, gear, outdoor items",
  },
  {
    value: "home",
    label: "Home & Garden",
  ...
  },
  {
    value: "collectibles",
    label: "Collectibles",
    description: "Art, antiques, memorabilia",
  },
  {
    value: "automotive",
    label: "Automotive",
  ...
  },
  {
    value: "crafts",
    label: "Arts & Crafts",
    description: "Handmade items, supplies",
  },
];
...
const EXPERIENCE_LEVELS: DropdownOption[] = [
  ...
  },
  {
    ...
    description: "A few successful trades",
  },
  {
    value: "experienced",
    label: "Experienced Trader",
    description: "Many successful trades",
  },
  {
    value: "expert",
    label: "Trading Expert",
    description: "Highly experienced, mentor others",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="glassmorphic border-glass backdrop-blur-xl bg-white/5 p-6">
        ...
        <div
          className={cn(
            "flex items-center space-x-2 text-sm transition-all duration-200 mt-4 p-3 rounded-lg glassmorphic border-glass backdrop-blur-sm",
            isValid
              ? "text-green-600 dark:text-green-400 bg-green-500/5"
              : "text-gray-500 dark:text-gray-400 bg-white/5"
          )}
        >
          <div
            className={cn(
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Add a photo and tell us about yourself to build trust with other
          traders.
        </p>
      </div>
      ...
      >
        ...
        <span>
          {isValid
            ...
            : "Please add a bio (minimum 20 characters)"}
        </span>
      </div>
    </motion.div>
  );
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Help us personalize your trading experience and connect you with the
          right opportunities.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <label className="flex items-center space-x-3">
            <input
              ...
              onChange={(e) =>
                onChange("openToCounterOffers", e.target.checked)
              }
          ...
          <label className="flex items-center space-x-3">
            <input
              ...
              onChange={(e) =>
                onChange("receiveRecommendations", e.target.checked)
              }
        ...
        <div className="space-y-3">
          <label className="flex items-center space-x-3">
            ...
            <span className="text-sm text-gray-900 dark:text-white">
              Email notifications for new trade offers
            </span>
          </label>
          ...
          <label className="flex items-center space-x-3">
            ...
            />
            <span className="text-sm text-gray-900 dark:text-white">
              Weekly digest of recommended trades
            </span>
          </label>
      ...
      >
        ...
        <span>
          {isValid
            ? "Trading preferences complete"
            : "Please complete all required preference fields"}
        </span>
      </div>
    </motion.div>
  );
        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-500">
              📍{" "}
              {
                LOCATION_OPTIONS.find((loc) => loc.value === data.location)
                  ?.label
              }
            </p>
            {data.phone && (
      ...
      <div className="glassmorphic border-glass backdrop-blur-xl bg-white/5 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <span className="ml-2 text-gray-900 dark:text-white font-medium">
              {
                EXPERIENCE_LEVELS.find(
                  (level) => level.value === data.experienceLevel
                )?.label
              }
            </span>
          </div>
          <div>
            ...
            <span className="ml-2 text-gray-900 dark:text-white font-medium">
              {data.preferredTradeMethod === "local"
                ? "Local Meetups"
                : data.preferredTradeMethod === "shipping"
                ? "Shipping"
                : "Both Methods"}
            </span>
          </div>
          ...
          <div className="mt-4">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {data.tradingInterests.map((interest: string) => {
                const category = TRADING_INTERESTS.find(
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Your profile is ready. Start exploring trades and connecting with
              the community.
            </p>
          </div>
        </div>

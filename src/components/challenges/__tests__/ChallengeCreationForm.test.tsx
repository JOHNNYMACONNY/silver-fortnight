...
jest.mock("framer-motion", () => {
  ...
  const make = (tag: any) => (props: any) =>
    React.createElement(String(tag), stripFramerProps(props), props.children);
...
jest.mock("lucide-react", () => {
  ...
  return {
    Zap: mockComponent("zap-icon"),
    TrendingUp: mockComponent("trending-up-icon"),
    Users: mockComponent("users-icon"),
    Calendar: mockComponent("calendar-icon"),
    Target: mockComponent("target-icon"),
    Award: mockComponent("award-icon"),
  };
});
...
describe("ChallengeCreationForm", () => {
  ...
  describe("Form Submission", () => {
    const fillValidForm = async (user: any) => {
      ...
      await user.type(
        screen.getByLabelText(/description/i),
        "This is a comprehensive test challenge description"
      );
    ...
    it("should submit form with valid data", async () => {
      ...
      expect(onChallengeCreated).toHaveBeenCalledWith({

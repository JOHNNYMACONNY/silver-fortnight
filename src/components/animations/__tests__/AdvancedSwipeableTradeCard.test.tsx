...
describe('AdvancedSwipeableTradeCard', () => {
  const mockTrade = {
    ...
    description: 'Looking to trade my web development expertise for design skills',
    creatorId: 'user-123',
    ...
    createdAt: { seconds: 1705312800, toDate: () => new Date('2024-01-15T10:00:00Z') },
    updatedAt: { seconds: 1705312800, toDate: () => new Date('2024-01-15T10:00:00Z') },
  };

  const mockActions: MultiStepSwipeAction[] = [
    {
      id: 'accept',
      direction: 'right',
      label: 'Accept',
  ...
  describe('Basic Rendering', () => {
    it('should render trade information correctly', () => {
      ...
      expect(screen.getByText('Web Development for Design Skills')).toBeInTheDocument();
  ...
  describe('Quick Actions', () => {
    it('should render quick action buttons when toggled', () => {
      ...
      // Quick actions are hidden by default, need to toggle them
      const toggleButton = screen.getByText('⋯');
      fireEvent.click(toggleButton);

      // Check for quick action icons (they don't have aria-labels in the current implementation)
  ...
  describe('Long Press Functionality', () => {
    it('should call onLongPress after long press duration', async () => {
      ...
      const card = screen.getByText('Web Development for Design Skills').closest('div');

...
jest.mock("../NavItem", () => {
  ...
  const MockNavItem = function MockNavItem(props: any) {
    ...
    return React.createElement(
      "button",
      { onClick, className, "data-testid": `nav-item-${to}` },
      icon,
      label
    );
  };
...
jest.mock("../Button", () => {
  ...
  return {
    ...
    Button: ({ children, onClick, variant, className }: any) =>
      React.createElement(
        "button",
        { onClick, className, "data-variant": variant },
        children
      ),
  };
});
...
describe("MobileMenu", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should render main navigation items", () => {
      ...
      // Check for all 7 main nav items (including Home and Leaderboard)
  ...
  describe("Accessibility", () => {
    ...
    it("should have proper section headings", () => {
      ...
      expect(navigationHeading).toHaveClass(
        "text-xs",
        "font-semibold",
        "uppercase"
      );

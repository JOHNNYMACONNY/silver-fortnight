...
import { ServiceRegistry, serviceRegistry } from '../../services/core/ServiceRegistry';
...
describe('Service Architecture', () => {
  ...
  describe('TradeService', () => {
    ...
    it('should accept trade correctly', async () => {
      const result = await tradeService.acceptTrade('trade123', 'user456', 'Jane Doe');
  ...
  describe('CollaborationService', () => {
    ...
    it('should create collaboration with proper validation', async () => {
      const collaborationData = {
        ...
        roles: [{ name: 'Developer', description: 'React expert needed' }],
        creatorId: 'user123',
    ...
    it('should join collaboration', async () => {
      const result = await collaborationService.joinCollaboration('collab123', 'user456');
    ...
    it('should leave collaboration', async () => {
      const result = await collaborationService.leaveCollaboration('collab123', 'user456');
    ...
    it('should get collaborations for user', async () => {
      const result = await collaborationService.getCollaborationsForUser('user123');
  ...
  describe('Service Integration', () => {
    it('should work together for complex operations', async () => {
      ...
      // Get trades for user
      const userTradesResult = await tradeService.getTradesByCreator('integration-user');
    ...
    it('should maintain data consistency across services', async () => {
      ...
      const collabResult = await collaborationService.createCollaboration({
        ...
        roles: [{ name: 'Tester', description: 'Test role' }],
